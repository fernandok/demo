 ...
 */
class sspmod_cypress_Auth_Source_External extends SimpleSAML_Auth_Source {
  ...
  public function authenticate(&$state) {
     ...
     */
    $state['cypress:AuthID'] = $this->authId;
     ...
     */
    $stateId = SimpleSAML_Auth_State::saveState($state, 'cypress:External');
     ...
     */
    $returnTo = SimpleSAML_Module::getModuleURL('cypress/resume.php', array(
        'State' => $stateId,
    ));
     ...
     */
    $authPage = SimpleSAML_Module::getModuleURL('cypress/authpage.php');
  ...
  public static function resume() {
     ...
     */
    $state = SimpleSAML_Auth_State::loadState($_REQUEST['State'], 'cypress:External');

    /*
     * Now we have the $state-array, and can use it to locate the authentication
     * source.
     */
    $source = SimpleSAML_Auth_Source::getById($state['cypress:AuthID']);
    if ($source === NULL) {
      /*
