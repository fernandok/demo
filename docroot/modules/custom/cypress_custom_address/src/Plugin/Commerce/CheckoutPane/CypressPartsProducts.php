...
class CypressPartsProducts extends CheckoutPaneBase {
    ...
    public function buildPaneForm(array $pane_form, FormStateInterface $form_state, array &$complete_form) {
        ...
        $primary_applications_options = [
            ...
            'computer systems / peripherals' => 'Computer Systems / Peripherals',
            ...
            'university / educational use' => 'University / Educational Use'
        ];

       // $values = $form_state;
        $value_dropdown_first = isset($form_state->getValue()['primary_application']) ? $form_state->getValue()['primary_application'] : key($primary_applications_options);
//kint($value_dropdown_first);exit;
$yo = $this->_second_dropdown_options($value_dropdown_first);
        ...
        $pane_form['primary_application'] = [
            ...
            '#ajax' => [
                'callback' => [get_called_class(), 'cypress_custom_address_ajax_callback'],
    ...
    //    kint($form_state->getValue(''));exit;
       ...
       $pane_form['dropdown_second'] = array(
           ...
           // '#suffix' => '</div>',
           '#options' => $this->_second_dropdown_options($value_dropdown_first),
           '#default_value' => isset($form_state->getValue()['dropdown_second']) ? $form_state->getValue()['dropdown_second'] : '',
        );

        return $pane_form;
    }

    public function _second_dropdown_options($key = ''){
        $options = [
            'automotive' => [
    ...
    public function cypress_custom_address_ajax_callback(&$form, FormStateInterface $form_state) {
